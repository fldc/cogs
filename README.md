...
<sup>1</sup> If you are not running Home Assistant on the default port, and another set of `''` after the API Password, and enter the port number you are using. For example: `remote.API('', '', '8765')` 
